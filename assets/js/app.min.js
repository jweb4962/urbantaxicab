...
! function(e, t) {
    ...
    var o, r, s = function(e) {
        ...
        d = function(e) {
            ...
            return o || r ? (i = i.split(",")[0], n = n.split(",")[0], 1e3 * (Number.parseFloat(i) + Number.parseFloat(n))) : 0
        },
        u = function(e) {
    ...
    function P(e, t, i) {
        var n = "string" == typeof t,
            ...
            r = e.replace(S, ""),
            s = E[r];
        return s && (r = s), A.has(r) || (r = e), [n, o, r]
    }
    ...
    function z(e, t, i, n, o) {
        if ("string" == typeof t && e) {
            ...
            if (u) u.oneOff = u.oneOff && o;
                ...
                var f = M(a, t.replace(T, "")),
                    p = s ? function(e, t, i) {
                        return function n(o) {
                            for (var r = e.querySelectorAll(t), s = o.target; s && s !== this; s = s.parentNode)
                                for (var a = r.length; a--;)
                                    if (r[a] === s) return o.delegateTarget = s, n.oneOff && W.off(e, o.type, i), i.apply(s, [o]);
                            return null
                        }
                    }(e, i, n) : function(e, t) {
                        return function i(n) {
                ...
                p.delegationSelector = s ? i : null, p.originalHandler = a, p.oneOff = o, p.uidEvent = f, d[f] = p, e.addEventListener(l, p, s)
            }
        }
    }
    ...
    function j(e, t, i, n, o) {
        var r = L(t[i], n, o);
        r && (e.removeEventListener(i, r, Boolean(o)), delete t[i][r.uidEvent])
    }
    var W = {
            on: function(e, t, i, n) {
                z(e, t, i, n, !1)
                ...
                if ("string" == typeof t && e) {
                    ...
                    if (void 0 === s) {
                        d && Object.keys(c).forEach((function(i) {
                            ! function(e, t, i, n) {
                                ...
                                Object.keys(o).forEach((function(r) {
                                    if (r.includes(n)) {
                                        var s = o[r];
                                        j(e, t, i, s.originalHandler, s.delegationSelector)
                                    }
                                }))
                            }(e, c, i, t.slice(1))
                        }));
                        ...
                        Object.keys(u).forEach((function(i) {
                            ...
                            if (!l || t.includes(n)) {
                                var o = u[i];
                                j(e, c, a, o.originalHandler, o.delegationSelector)
                            }
                        }))
                    } else {
                        if (!c || !c[a]) return;
            ...
            trigger: function(e, t, i) {
                ...
                var n, o = y(),
                    ...
                    d = !1,
                    u = null;
                return s && o && (n = o.Event(t, i), o(e).trigger(n), l = !n.isPropagationStopped(), c = !n.isImmediatePropagationStopped(), d = n.isDefaultPrevented()), a ? (u = document.createEvent("HTMLEvents")).initEvent(r, l, !0) : u = new CustomEvent(t, {
                    bubbles: l,
                    cancelable: !0
    ...
    W.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', F.handleDismiss(new F)), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[$];
            e.fn[$] = F.jQueryInterface, e.fn[$].Constructor = F, e.fn[$].noConflict = function() {
                return e.fn[$] = t, F.jQueryInterface
            }
        }
    }));
    var N = function(e) {
    ...
    W.on(document, "click.bs.button.data-api", '[data-bs-toggle="button"]', (function(e) {
        ...
        var t = e.target.closest('[data-bs-toggle="button"]'),
            i = x(t, "bs.button");
        i || (i = new N(t)), i.toggle()
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn.button;
            e.fn.button = N.jQueryInterface, e.fn.button.Constructor = N, e.fn.button.noConflict = function() {
                return e.fn.button = t, N.jQueryInterface
            }
        }
    }));
    var q = {
            ...
            getDataAttribute: function(e, t) {
                return R(e.getAttribute("data-bs-" + B(t)))
            },
            offset: function(e) {
        ...
        K = function(e) {
            ...
            return r.next = function() {
                ...
                if ("next" === e ? (i = "carousel-item-start", n = "carousel-item-next", o = "left") : (i = "carousel-item-end", n = "carousel-item-prev", o = "right"), l && l.classList.contains("active")) this._isSliding = !1;
                    ...
                    if (this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l), this._activeElement = l, this._element.classList.contains("slide")) {
                        ...
                        W.one(s, "transitionend", (function() {
                            l.classList.remove(i, n), l.classList.add("active"), s.classList.remove("active", n, i), r._isSliding = !1, setTimeout((function() {
                    ...
                    } else s.classList.remove("active"), l.classList.add("active"), this._isSliding = !1, W.trigger(this._element, "slid.bs.carousel", {
                        relatedTarget: l,
                        direction: o,
                        from: a,
                        to: c
                ...
                var n = x(e, "bs.carousel"),
                    r = i({}, J, q.getDataAttributes(e));
                "object" == typeof t && (r = i({}, r, t));
                var s = "string" == typeof t ? t : r.slide;
                if (n || (n = new o(e, r)), "number" == typeof t) n.to(t);
                ...
                if (t && t.classList.contains("carousel")) {
                    ...
                    r && (n.interval = !1), o.carouselInterface(t, n), r && x(t, "bs.carousel").to(r), e.preventDefault()
                }
            }, t(o, null, [{
                key: "Default",
                get: function() {
    ...
    W.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", K.dataApiClickHandler), W.on(window, "load.bs.carousel.data-api", (function() {
        for (var e = Y.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++) K.carouselInterface(e[t], x(e[t], "bs.carousel"))
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[U];
    ...
    var V = "collapse",
        ...
        ee = function(e) {
            ...
            return r.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    ...
                    if (!W.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        ...
                        W.one(this._element, "transitionend", (function() {
                            e._element.classList.remove("collapsing"), e._element.classList.add("collapse", "show"), e._element.style[s] = "", e.setTransitioning(!1), W.trigger(e._element, "shown.bs.collapse")
                ...
                return (e = i({}, G, e)).toggle = Boolean(e.toggle), h(V, e, Z), e
                ...
                var n = x(e, "bs.collapse"),
                    r = i({}, G, q.getDataAttributes(e), "object" == typeof t && t ? t : {});
                if (!n && r.toggle && "string" == typeof t && /show|hide/.test(t) && (r.toggle = !1), n || (n = new o(e, r)), "string" == typeof t) {
        ...
        fn: function(e) {
            ...
            Object.keys(t.elements).forEach((function(e) {
                var i = t.styles[e] || {},
                    n = t.attributes[e] || {},
                    o = t.elements[e];
                fe(o) && ce(o) && (Object.assign(o.style, i), Object.keys(n).forEach((function(e) {
                    var t = n[e];
            ...
            return Object.assign(t.elements.popper.style, i.popper), t.elements.arrow && Object.assign(t.elements.arrow.style, i.arrow),
                function() {
                    Object.keys(t.elements).forEach((function(e) {
                        ...
                        fe(n) && ce(n) && (Object.assign(n.style, r), Object.keys(o).forEach((function(e) {
                            n.removeAttribute(e)
                        })))
                    }))
                }
    ...
    function ke(e) {
        ...
        return i && "body" === ce(i) && "static" === ve(i).position ? t : i || function(e) {
            for (var t = we(e); fe(t) && ["html", "body"].indexOf(ce(t)) < 0;) {
                var i = ve(t);
    ...
    var De = {
            ...
            fn: function(e) {
                ...
                if (o && r) {
                    var c = i.modifiersData[n + "#persistent"].padding,
                        ...
                        u = "y" === a ? te : oe,
                        f = "y" === a ? ie : ne,
                        p = i.rects.reference[l] + i.rects.reference[a] - r[a] - i.rects.popper[l],
            ...
            effect: function(e) {
                ...
                null != r && ("string" != typeof r || (r = t.elements.popper.querySelector(r))) && ge(t.elements.popper, r) && (t.elements.arrow = r, t.modifiersData[n + "#persistent"] = {
                    padding: Se("number" != typeof a ? a : Ce(a, re))
                })
            },
    ...
    function Ee(e) {
        ...
        return a ? Object.assign(Object.assign({}, b), {}, ((y = {})[m] = p ? "0" : "", y[h] = f ? "0" : "", y.transform = (g.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + u + "px)" : "translate3d(" + d + "px, " + u + "px, 0)", y)) : Object.assign(Object.assign({}, b), {}, ((t = {})[m] = p ? u + "px" : "", t[h] = f ? d + "px" : "", t.transform = "", t))
    }
    var Ae = {
            name: "computeStyles",
            enabled: !0,
        ...
        Ie = {
            ...
            effect: function(e) {
                ...
                return r && c.forEach((function(e) {
                        e.addEventListener("scroll", i.update, Me)
    ...
    function $e(e) {
        return We(be(e)).left + He(e).scrollLeft
    }
    ...
    function Ne(e, t) {
        void 0 === t && (t = []);
        var i = function e(t) {
                return ["html", "body", "#document"].indexOf(ce(t)) >= 0 ? t.ownerDocument.body : fe(t) && Fe(t) ? t : e(we(t))
            }(e),
            n = "body" === ce(i),
            o = de(i),
            r = n ? [o].concat(o.visualViewport || [], Fe(i) ? i : []) : i,
            s = t.concat(r);
        return n ? s : s.concat(Ne(we(r)))
    }
    ...
    function Be(e, t) {
        return "viewport" === t ? Re(function(e) {
            var t = de(e),
                ...
                s = 0,
                a = 0;
            return n && (o = n.width, r = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (s = n.offsetLeft, a = n.offsetTop)), {
                width: o,
                height: r,
                x: s + $e(e),
                y: a
            ...
            var t = be(e),
                ...
                s = -i.scrollLeft + $e(e),
                a = -i.scrollTop;
            return "rtl" === ve(n || t).direction && (s += Math.max(t.clientWidth, n ? n.clientWidth : 0) - o), {
                width: o,
                height: r,
                x: s,
                y: a
    ...
    function Ue(e, t) {
        ...
        var i = t,
            ...
            p = i.padding,
            h = void 0 === p ? 0 : p,
            m = Se("number" != typeof h ? h : Ce(h, re)),
            ...
            w = function(e, t, i) {
                var n = "clippingParents" === t ? function(e) {
                        var t = Ne(we(e)),
                            i = ["absolute", "fixed"].indexOf(ve(e).position) >= 0 && fe(e) ? ke(e) : e;
            ...
            x = Re(Object.assign(Object.assign({}, y), k)),
            T = "popper" === d ? x : _,
            S = {
    ...
    var Je = {
        ...
        fn: function(e) {
            ...
            if (!t.modifiersData[n]._skip) {
                for (var o = i.mainAxis, r = void 0 === o || o, s = i.altAxis, a = void 0 === s || s, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, f = i.altBoundary, p = i.flipVariations, h = void 0 === p || p, m = i.allowedAutoPlacements, g = t.options.placement, v = he(g), y = l || (v !== g && h ? function(e) {
                        if ("auto" === he(e)) return [];
                        var t = Pe(e);
                        return [je(e), t, je(t)]
                    }(g) : [Pe(g)]), b = [g].concat(y).reduce((function(e, i) {
                    ...
                    }), []), w = t.rects.reference, _ = t.rects.popper, k = new Map, x = !0, T = b[0], S = 0; S < b.length; S++) {
                    var C = b[S],
                        D = he(C),
                        O = "start" === qe(C),
                        E = [te, ie].indexOf(D) >= 0,
                    ...
                    var L = Pe(I),
                        P = [];
                    if (r && P.push(M[D] <= 0), a && P.push(M[I] <= 0, M[L] <= 0), P.every((function(e) {
                            return e
                        }))) {
                        T = C, x = !1;
                        break
                    ...
                    s = ae.reduce((function(e, i) {
                        return e[i] = function(e, t, i) {
                            var n = he(e),
                                ...
                                s = r[0],
                                a = r[1];
                            return s = s || 0, a = (a || 0) * o, [oe, ne].indexOf(n) >= 0 ? {
                                x: a,
                                y: s
                            } : {
                                x: s,
                ...
                if (k) {
                    if (r) {
                        var D = "y" === w ? te : oe,
                            ...
                            F = H[O],
                            N = Te(0, x[E], W[E]),
                            R = b ? x[E] / 2 - L - N - $ - S : P - N - $ - S,
                            B = b ? -x[E] / 2 + L + N + F + S : z + N + F + S,
                            q = t.elements.arrow && ke(t.elements.arrow),
                            Y = q ? "y" === w ? q.clientTop || 0 : q.clientLeft || 0 : 0,
                            U = t.modifiersData.offset ? t.modifiersData.offset[t.placement][w] : 0,
                            J = k[w] + R - U - Y,
                            Q = k[w] + B - U,
                            X = Te(p ? Math.min(M, J) : M, A, p ? Math.max(I, Q) : I);
                        k[w] = X, C[w] = X - A
                    }
                    if (a) {
                        var K = "x" === w ? te : oe,
    ...
    function et(e, t, i) {
        ...
        return (a || !a && !i) && (("body" !== ce(t) || Fe(r)) && (l = (n = t) !== de(n) && fe(n) ? {
            scrollLeft: (o = n).scrollLeft,
            scrollTop: o.scrollTop
        } : He(n)), fe(t) ? ((c = We(t)).x += t.clientLeft, c.y += t.clientTop) : r && (c.x = $e(r))), {
                ...
                d = {
                    ...
                    setOptions: function(i) {
                        u(), a.options = Object.assign(Object.assign(Object.assign({}, r), a.options), i), a.scrollParents = {
                            reference: ue(e) ? Ne(e) : e.contextElement ? Ne(e.contextElement) : [],
                            popper: Ne(t)
                        };
                        ...
                        }((o = [].concat(n, a.options.modifiers), s = o.reduce((function(e, t) {
                            var i = e[t.name];
    ...
    var ot = nt(),
        rt = nt({
            defaultModifiers: [Ie, Ge, Ae, pe]
        }),
        st = nt({
            defaultModifiers: [Ie, Ge, Ae, pe, Ve, Je, Ze, De, Ke]
        }),
        at = Object.freeze({
            __proto__: null,
            popperGenerator: nt,
        ...
        yt = function(e) {
            ...
            return r.toggle = function() {
                ...
                if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                    ...
                    if (!W.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                        if (!this._inNavbar) {
                            ...
                            var i = this._element;
                            "parent" === this._config.reference ? i = e : f(this._config.reference) && (i = this._config.reference, void 0 !== this._config.reference.jquery && (i = this._config.reference[0])), this._popper = st(i, this._menu, this._getPopperConfig())
                        }
                        var n;
                ...
                return e.classList.contains("dropup") ? t ? ut : dt : t ? pt : ft
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                    for (var t = Y.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                        var r = o.getParentFromElement(t[i]),
                            s = x(t[i], "bs.dropdown"),
                            a = {
                                relatedTarget: t[i]
                            };
                        if (e && "click" === e.type && (a.clickEvent = e), s) {
                            var l, c = s._menu;
                            if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && c.contains(e.target) || W.trigger(r, "hide.bs.dropdown", a).defaultPrevented)) "ontouchstart" in document.documentElement && (l = []).concat.apply(l, document.body.children).forEach((function(e) {
                                return W.off(e, "mouseover", null, (function() {}))
                            })), t[i].setAttribute("aria-expanded", "false"), s._popper && s._popper.destroy(), c.classList.remove("show"), t[i].classList.remove("show"), W.trigger(r, "hidden.bs.dropdown", a)
                        }
                    }
        ...
        _t = function(e) {
            ...
            return r.toggle = function(e) {
                ...
                if (i) {
                    ...
                    W.one(this._dialog, "transitionend", o), p(this._dialog, r)
                } else o()
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    W.one(this._backdrop, "transitionend", e), p(this._backdrop, n)
                    ...
                    if (this._element.classList.contains("fade")) {
                        ...
                        W.one(this._backdrop, "transitionend", o), p(this._backdrop, r)
                    } else o()
                } else e()
                ...
                return this.each((function() {
                    ...
                    if (n || (n = new o(this, r)), "string" == typeof e) {
    ...
    function St(e, t, i) {
        ...
        for (var o = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), s = (n = []).concat.apply(n, o.body.querySelectorAll("*")), a = function(e, i) {
                var n, o = s[e],
                ...
                l.forEach((function(e) {
                    (function(e, t) {
                        ...
                        if (t.includes(i)) return !kt.has(i) || Boolean(e.nodeValue.match(xt) || e.nodeValue.match(Tt));
        ...
        Lt = function(e) {
            ...
            return r.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    k(o, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || c.appendChild(o), W.trigger(this._element, this.constructor.Event.INSERTED), this._popper = st(this._element, o, this._getPopperConfig(l)), o.classList.add("show");
                    var u, f, h = "function" == typeof this.config.customClass ? this.config.customClass() : this.config.customClass;
                    h && (u = o.classList).add.apply(u, h.split(" ")), "ontouchstart" in document.documentElement && (f = []).concat.apply(f, document.body.children).forEach((function(e) {
                    ...
                    if (this.tip.classList.contains("fade")) {
                        var g = d(this.tip);
                        W.one(this.tip, "transitionend", m), p(this.tip, g)
                    } else m()
                }
            }, r.hide = function() {
                var e = this;
                ...
                var i = this.constructor.DATA_KEY;
                (t = t || x(e.delegateTarget, i)) || (t = new this.constructor(e.delegateTarget, this._getDelegateConfig()), k(e.delegateTarget, i, t)), e && (t._activeTrigger["focusout" === e.type ? "focus" : "hover"] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout((function() {
                ...
                return Object.keys(t).forEach((function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), h(Ct, e, this.constructor.DefaultType), e.sanitize && (e.template = St(e.template, e.allowList, e.sanitizeFn)), e
    ...
    b((function() {
        ...
        if (e) {
            var t = e.fn[Pt];
            e.fn[Pt] = $t.jQueryInterface, e.fn[Pt].Constructor = $t, e.fn[Pt].noConflict = function() {
                return e.fn[Pt] = t, $t.jQueryInterface
            }
        }
    }));
    var Ft = "scrollspy",
        ...
        Bt = function(e) {
            ...
            return r.refresh = function() {
                ...
                if ("string" != typeof(e = i({}, Nt, "object" == typeof e && e ? e : {})).target && f(e.target)) {
                    var t = e.target.id;
    ...
    W.on(window, "load.bs.scrollspy.data-api", (function() {
        Y.find('[data-bs-spy="scroll"]').forEach((function(e) {
            return new Bt(e, q.getDataAttributes(e))
        }))
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[Ft];
            e.fn[Ft] = Bt.jQueryInterface, e.fn[Ft].Constructor = Bt, e.fn[Ft].noConflict = function() {
                return e.fn[Ft] = t, Bt.jQueryInterface
            }
        }
    }));
    var qt = function(e) {
        ...
        return o.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                ...
                var r = null;
                if (t && (r = W.trigger(t, "hide.bs.tab", {
                        relatedTarget: this._element
            ...
            if (o && r) {
                var a = d(o);
                o.classList.remove("show"), W.one(o, "transitionend", s), p(o, a)
            } else s()
            ...
            return r.show = function() {
                ...
                if (!W.trigger(this._element, "show.bs.toast").defaultPrevented) {
                    ...
                    if (this._element.classList.remove("hide"), v(this._element), this._element.classList.add("showing"), this._config.animation) {
                        ...
                        W.one(this._element, "transitionend", t), p(this._element, i)
                    } else t()
                }
            }, r.hide = function() {
                var e = this;
                ...
                return e = i({}, Ut, q.getDataAttributes(this._element), "object" == typeof e && e ? e : {}), h("toast", e, this.constructor.DefaultType), e
            }, r._setListeners = function() {
                var e = this;
    ...
    return b((function() {
        ...
        if (e) {
            var t = e.fn.toast;
            e.fn.toast = Jt.jQueryInterface, e.fn.toast.Constructor = Jt, e.fn.toast.noConflict = function() {
                return e.fn.toast = t, Jt.jQueryInterface
            }
        }
    })), {
        Alert: F,
...
function(e, t) {
    ...
    function i(i, r, a) {
        (a = a || t || e.jQuery) && (r.prototype.option || (r.prototype.option = function(e) {
            ...
            var t, n, l, c, d, u, f = o.call(arguments, 1);
            return l = f, d = "$()." + i + '("' + (n = e) + '")', (t = this).each((function(e, t) {
                var o = a.data(t, i);
                if (o) {
                    var r = o[n];
                    if (r && "_" != n.charAt(0)) {
                        var u = r.apply(o, l);
                        c = void 0 === c ? u : c
                    } else s(d + " is not a valid method")
                } else s(i + " not initialized. Cannot call methods, i.e. " + d)
            })), void 0 !== c ? c : t
        }, n(a))
    }
    ...
    return function n(a) {
        if (function() {
                if (!s) {
                    ...
                    r.appendChild(o);
                    var a = t(o);
                    i = 200 == Math.round(e(a.width)), n.isBoxSizeOuter = i, r.removeChild(o)
                }
            ...
            var x = e(l.height);
            return !1 !== x && (c.height = x + (_ ? 0 : g + w)), c.innerWidth = c.width - (m + b), c.innerHeight = c.height - (g + w), c.outerWidth = c.width + v, c.outerHeight = c.height + y, c
        }
    }
})),
function(e, t) {
            ...
            t.waypoint((function(r) {
                ! function() {
                    ...
                    for (var p = s; p >= o.beginAt / a * s; p--) {
                        var h = parseFloat(a / s * p).toFixed(c);
                        if (d) {
                            h = parseInt(i / s * p);
                    ...
                    t.data("counterup-nums", r), t.text(o.beginAt);
...
function() {
    ...
    e = function(e, t) {
        ...
        parseDate: function(t, i) {
            var n, o, r, s, a, l, c, d, u, f, p = this,
                h = !1,
                m = !1,
                g = p.dateSettings,
                v = {
            ...
            for (o = t.replace(p.separators, "\0").split("\0"), r = 0; r < o.length; r++) switch (s = o[r], a = parseInt(s), n[r]) {
                case "y":
                case "Y":
                    if (!a) return null;
                    u = s.length, v.year = 2 === u ? parseInt((a < 70 ? "20" : "19") + s) : a, h = !0;
                    break;
                case "m":
                case "n":
                case "M":
                case "F":
                    if (isNaN(a)) {
                        if (!(0 < (l = p.getMonth(s)))) return null;
                        v.month = l
                    } else {
                ...
                case "g":
                case "h":
                    if (f = o[c = -1 < n.indexOf("a") ? n.indexOf("a") : -1 < n.indexOf("A") ? n.indexOf("A") : -1], -1 < c) d = e(f, g.meridiem[0]) ? 0 : e(f, g.meridiem[1]) ? 12 : -1, 1 <= a && a <= 12 && -1 < d ? v.hour = a + d - 1 : 0 <= a && a <= 23 && (v.hour = a);
                    else {
        ...
        guessDate: function(e, t) {
            if ("string" != typeof e) return e;
            var i, n, o, r, s, a, l = e.replace(this.separators, "\0").split("\0"),
                c = t.match(this.validParts),
                d = new Date,
                u = 0;
            if (!/^[djmn]/g.test(c[0])) return e;
            for (o = 0; o < l.length; o++) {
                if (u = 2, s = l[o], a = parseInt(s.substr(0, 2)), isNaN(a)) return null;
                switch (o) {
                    case 0:
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        if (n = d.getFullYear(), u = (i = s.length) < 4 ? i : 4, !(n = parseInt(i < 4 ? n.toString().substr(0, 4 - i) + s : s.substr(0, 4)))) return null;
                        d.setFullYear(n);
                        break;
                    case 3:
                        d.setHours(a);
                ...
                0 < (r = s.substr(u)).length && l.splice(o + 1, 0, r)
            }
            return d
        },
        ...
        formatDate: function(e, t) {
            ...
            if (e instanceof Date) {
                for (o = t.length, i = 0; i < o; i++) "S" !== (s = t.charAt(i)) && "\\" !== s && (0 < i && "\\" === t.charAt(i - 1) ? a += s : (r = this.parseFormat(s, e), i !== o - 1 && this.intParts.test(s) && "S" === t.charAt(i + 1) && (n = parseInt(r) || 0, r += this.dateSettings.ordinal(n)), a += r));
                return a
            }
            return ""
        }
...
var datetimepickerFactory = function(e) {
    ...
    e.extend(e.datetimepicker, l), s(), window.getComputedStyle || (window.getComputedStyle = function(e) {
        ...
        return this.each((function() {
            var n, o, r, s, a, l = e(this),
                ...
                g = 0,
                v = function() {};
            "hide" !== i ? (e(this).hasClass("xdsoft_scroller_box") || (n = l.children().eq(0), o = l[0].clientHeight, r = n[0].offsetHeight, s = e('<div class="xdsoft_scrollbar"></div>'), a = e('<div class="xdsoft_scroller"></div>'), s.append(a), l.addClass("xdsoft_scroller_box").append(s), v = function(e) {
                var t = c(e).y - f + g;
                t < 0 && (t = 0), t + a[0].offsetHeight > h && (t = h - a[0].offsetHeight), l.trigger("scroll_element.xdsoft_scroller", [d ? t / d : 0])
            }, a.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", (function(n) {
                o || l.trigger("resize_scroll.xdsoft_scroller", [i]), f = c(n).y, g = parseInt(a.css("margin-top"), 10), h = s[0].offsetHeight, "mousedown" === n.type || "touchstart" === n.type ? (t.ownerDocument && e(t.ownerDocument.body).addClass("xdsoft_noselect"), e([t.ownerDocument.body, t.contentWindow]).on("touchend mouseup.xdsoft_scroller", (function i() {
                ...
                var c, u;
                o = l[0].clientHeight, r = n[0].offsetHeight, u = (c = o / r) * s[0].offsetHeight, 1 < c ? a.hide() : (a.show(), a.css("height", parseInt(10 < u ? u : 10, 10)), d = s[0].offsetHeight - a[0].offsetHeight, !0 !== i && l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(n.css("marginTop"), 10)) / (r - o)]))
                ...
                u = c(e), p = Math.abs(parseInt(n.css("marginTop"), 10))
        ...
        var s, a, l = this,
            ...
            C = 0;
        return s = function(t) {
            var r, s, a, l, C, D, O = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
                ...
                M = e('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'),
            ...
            S.id && O.attr("id", S.id), S.style && O.attr("style", S.style), S.weeks && O.addClass("xdsoft_showweeks"), S.rtl && O.addClass("xdsoft_rtl"), O.addClass("xdsoft_" + S.theme), O.addClass(S.className), M.find(".xdsoft_month span").after(W), M.find(".xdsoft_year span").after(H), M.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", (function(t) {
                var i, n, o = e(this).find(".xdsoft_select").eq(0),
                    ...
                    s = 0,
                    a = o.is(":visible");
                for (M.find(".xdsoft_select").hide(), C.currentTime && (r = C.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), o[a ? "hide" : "show"](), i = o.find("div.xdsoft_option"), n = 0; n < i.length && i.eq(n).data("value") !== r; n += 1) s += i[0].offsetHeight;
                return o.xdsoftScroller(S, s / (o.children()[0].offsetHeight - o[0].clientHeight)), t.stopPropagation(), !1
            }));
            var N = function(e) {
            ...
            function B(n) {
                ...
                n.mask && t.off("keydown.xdsoft"), !0 === n.mask && (i.formatMask ? n.mask = i.formatMask(n.format) : n.mask = n.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === e.type(n.mask) && (o(n.mask, t.val()) || (t.val(n.mask.replace(/[0-9]/g, "_")), r(t[0], 0)), t.on("paste.xdsoft", (function(i) {
                    var s = (i.clipboardData || i.originalEvent.clipboardData || window.clipboardData).getData("text"),
                        a = this.value,
                        l = this.selectionStart;
                    return a = a.substr(0, l) + s + a.substr(l + s.length), l += s.length, o(n.mask, a) ? (this.value = a, r(this, l)) : "" === e.trim(a) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft"), i.preventDefault(), !1
                    ...
                    if (48 <= l && l <= 57 || 96 <= l && l <= 105 || 8 === l || 46 === l) {
                        for (s = 8 === l || 46 === l ? "_" : String.fromCharCode(96 <= l && l <= 105 ? l - 48 : l), 8 === l && d && !C && (d -= 1);;) {
                        ...
                        if (i.metaKey && (C = !(d = 0)), C) {
                            var A = S - d,
                                ...
                                I = M.substr(d, A).substr(1);
                            a = a.substr(0, d) + (s + I) + a.substr(d + A)
                        ...
                        o(n.mask, a) ? (this.value = a, r(this, d)) : "" === e.trim(a) ? this.value = n.mask.replace(/[0-9]/g, "_") : t.trigger("error_input.xdsoft")
                    } else if (-1 !== [b, w, _, k, x].indexOf(l) && T || -1 !== [f, h, g, p, m, y, c, v, u].indexOf(l)) return !0;
                    return i.preventDefault(), !1
                })))
            }
            M.find(".xdsoft_select").xdsoftScroller(S).on("touchstart mousedown.xdsoft", (function(e) {
                var t = e.originalEvent;
                ...
                S = e.extend(!0, {}, S, n), n.allowTimes && e.isArray(n.allowTimes) && n.allowTimes.length && (S.allowTimes = e.extend(!0, [], n.allowTimes)), n.weekends && e.isArray(n.weekends) && n.weekends.length && (S.weekends = e.extend(!0, [], n.weekends)), n.allowDates && e.isArray(n.allowDates) && n.allowDates.length && (S.allowDates = e.extend(!0, [], n.allowDates)), n.allowDateRe && "[object String]" === Object.prototype.toString.call(n.allowDateRe) && (S.allowDateRe = new RegExp(n.allowDateRe)), n.highlightedDates && e.isArray(n.highlightedDates) && n.highlightedDates.length && (e.each(n.highlightedDates, (function(t, n) {
                    var r, s = e.map(n.split(","), e.trim),
                        a = new d(i.parseDate(s[0], S.formatDate), s[1], s[2]),
                        l = i.formatDate(a.date, S.formatDate);
                    void 0 !== o[l] ? (r = o[l].desc) && r.length && a.desc && a.desc.length && (o[l].desc = r + "\n" + a.desc) : o[l] = a
                    ...
                    var r, s, a, l, c, u, f;
                    if (e.isArray(n)) r = n[0], s = n[1], a = n[2], f = n[3];
                    else {
                        var p = e.map(n.split(","), e.trim);
                        r = i.parseDate(p[0], S.formatDate), s = i.parseDate(p[1], S.formatDate), a = p[2], f = p[3]
                    }
                    for (; r <= s;) l = new d(r, a, f), c = i.formatDate(r, S.formatDate), r.setDate(r.getDate() + 1), void 0 !== o[c] ? (u = o[c].desc) && u.length && l.desc && l.desc.length && (o[c].desc = u + "\n" + l.desc) : o[c] = l
                ...
                return e.stopPropagation(), e.preventDefault(), H.hide(), W.hide(), !1
            })), P.append(z), P.xdsoftScroller(S), O.on("afterOpen.xdsoft", (function() {
                P.xdsoftScroller(S)
            })), O.append(A).append(L), !0 !== S.withoutCopyright && O.append(E), A.append(M).append(I).append(j), S.insideParent ? e(t).parent().append(O) : e(S.parentID).append(O), C = new function() {
                var t = this;
                t.now = function(e) {
                    var i, n, o = new Date;
                    ...
                    var n, o, r = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : ((r = /^([+-]{1})(.*)$/.exec(e)) && (r[2] = i.parseDate(r[2], S.formatDate)), o = r && r[2] ? (n = r[2].getTime() - 6e4 * r[2].getTimezoneOffset(), new Date(t.now(!0).getTime() + parseInt(r[1] + "1", 10) * n)) : e ? i.parseDate(e, S.format) : t.now(), t.isValidDate(o) || (o = t.now()), o)
                ...
                e.preventDefault(), O.data("changed", !0), C.setCurrentTime(R()), t.val(C.str()), O.trigger("close.xdsoft")
                ...
                ! function e(r) {
                    ...
                    t.hasClass(S.next) && a - s - S.timeHeightInTimePicker >= l ? z.css("marginTop", "-" + (l + S.timeHeightInTimePicker) + "px") : t.hasClass(S.prev) && 0 <= l - S.timeHeightInTimePicker && z.css("marginTop", "-" + (l - S.timeHeightInTimePicker) + "px"), P.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(z[0].style.marginTop, 10) / (a - s))]), o = 10 < o ? 10 : o - 10, n || (i = setTimeout(e, r || o))
                }(500), e([S.ownerDocument.body, S.contentWindow]).on("touchend mouseup.xdsoft", (function t() {
                    clearTimeout(i), n = !0, e([S.ownerDocument.body, S.contentWindow]).off("touchend mouseup.xdsoft", t)
                }))
            })), r = 0, O.on("xchange.xdsoft", (function(s) {
                clearTimeout(r), r = setTimeout((function() {
                    void 0 !== C.currentTime && null !== C.currentTime || (C.currentTime = C.now());
                    for (var r, s, a, l, c, d, u, f, p, h, m = "", g = new Date(C.currentTime.getFullYear(), C.currentTime.getMonth(), 1, 12, 0, 0), v = 0, y = C.now(), b = !1, w = !1, _ = !1, k = !1, x = [], T = !0, D = ""; g.getDay() !== S.dayOfWeekStart;) g.setDate(g.getDate() - 1);
                    for (m += "<table><thead><tr>", S.weeks && (m += "<th></th>"), r = 0; r < 7; r += 1) m += "<th>" + S.i18n[o].dayOfWeekShort[(r + S.dayOfWeekStart) % 7] + "</th>";
                    for (m += "</tr></thead>", m += "<tbody>", !1 !== S.maxDate && (b = C.strToDate(S.maxDate), b = new Date(b.getFullYear(), b.getMonth(), b.getDate(), 23, 59, 59, 999)), !1 !== S.minDate && (w = C.strToDate(S.minDate), w = new Date(w.getFullYear(), w.getMonth(), w.getDate())), !1 !== S.minDateTime && (_ = C.strToDate(S.minDateTime), _ = new Date(_.getFullYear(), _.getMonth(), _.getDate(), _.getHours(), _.getMinutes(), _.getSeconds())), !1 !== S.maxDateTime && (k = C.strToDate(S.maxDateTime), k = new Date(k.getFullYear(), k.getMonth(), k.getDate(), k.getHours(), k.getMinutes(), k.getSeconds())), !1 !== k && (h = 31 * (12 * k.getFullYear() + k.getMonth()) + k.getDate()); v < C.currentTime.countDaysInMonth() || g.getDay() !== S.dayOfWeekStart || C.currentTime.getMonth() === g.getMonth();) {
                        ...
                        (!1 !== b && b < g || !1 !== _ && g < _ || !1 !== w && g < w || !1 !== k && h < E || u && !1 === u[0]) && x.push("xdsoft_disabled"), -1 !== S.disabledDates.indexOf(i.formatDate(g, S.formatDate)) && x.push("xdsoft_disabled"), -1 !== S.disabledWeekDays.indexOf(a) && x.push("xdsoft_disabled"), t.is("[disabled]") && x.push("xdsoft_disabled"), u && "" !== u[1] && x.push(u[1]), C.currentTime.getMonth() !== j && x.push("xdsoft_other_month"), (S.defaultSelect || O.data("changed")) && i.formatDate(C.currentTime, S.formatDate) === i.formatDate(g, S.formatDate) && x.push("xdsoft_current"), i.formatDate(y, S.formatDate) === i.formatDate(g, S.formatDate) && x.push("xdsoft_today"), 0 !== g.getDay() && 6 !== g.getDay() && -1 === S.weekends.indexOf(i.formatDate(g, S.formatDate)) || x.push("xdsoft_weekend"), void 0 !== S.highlightedDates[i.formatDate(g, S.formatDate)] && (s = S.highlightedDates[i.formatDate(g, S.formatDate)], x.push(void 0 === s.style ? "xdsoft_highlighted_default" : s.style), p = void 0 === s.desc ? "" : s.desc), S.beforeShowDay && e.isFunction(S.beforeShowDay) && x.push(S.beforeShowDay(g)), T && (m += "<tr>", T = !1, S.weeks && (m += "<th>" + d + "</th>")), m += '<td data-date="' + l + '" data-month="' + j + '" data-year="' + c + '" class="xdsoft_date xdsoft_day_of_week' + g.getDay() + " " + x.join(" ") + '" title="' + p + '"><div>' + l + "</div></td>", g.getDay() === S.dayOfWeekStartPrev && (m += "</tr>", T = !0), g.setDate(l + 1)
                    }
                    m += "</tbody></table>", I.html(m), M.find(".xdsoft_label span").eq(0).text(S.i18n[o].months[C.currentTime.getMonth()]), M.find(".xdsoft_label span").eq(1).text(C.currentTime.getFullYear() + S.yearOffset), j = D = "";
                    var A = 0;
                    if (!1 !== S.minTime) {
                        var L = C.strtotime(S.minTime);
                        A = 60 * L.getHours() + L.getMinutes()
                    }
                    var P = 1440;
                    if (!1 !== S.maxTime && (L = C.strtotime(S.maxTime), P = 60 * L.getHours() + L.getMinutes()), !1 !== S.minDateTime && (L = C.strToDateTime(S.minDateTime), i.formatDate(C.currentTime, S.formatDate) === i.formatDate(L, S.formatDate))) {
                        var j = 60 * L.getHours() + L.getMinutes();
                        A < j && (A = j)
                    }
                    if (!1 !== S.maxDateTime && (L = C.strToDateTime(S.maxDateTime), i.formatDate(C.currentTime, S.formatDate) === i.formatDate(L, S.formatDate) && (j = 60 * L.getHours() + L.getMinutes()) < P && (P = j)), f = function(n, o) {
                            var r, s = C.now(),
                                a = S.allowTimes && e.isArray(S.allowTimes) && S.allowTimes.length;
                            s.setHours(n), n = parseInt(s.getHours(), 10), s.setMinutes(o), o = parseInt(s.getMinutes(), 10), x = [];
                            var l = 60 * n + o;
                            (t.is("[disabled]") || P <= l || l < A) && x.push("xdsoft_disabled"), (r = new Date(C.currentTime)).setHours(parseInt(C.currentTime.getHours(), 10)), a || r.setMinutes(Math[S.roundTime](C.currentTime.getMinutes() / S.step) * S.step), (S.initTime || S.defaultSelect || O.data("changed")) && r.getHours() === parseInt(n, 10) && (!a && 59 < S.step || r.getMinutes() === parseInt(o, 10)) && (S.defaultSelect || O.data("changed") ? x.push("xdsoft_current") : S.initTime && x.push("xdsoft_init_time")), parseInt(y.getHours(), 10) === parseInt(n, 10) && parseInt(y.getMinutes(), 10) === parseInt(o, 10) && x.push("xdsoft_today"), D += '<div class="xdsoft_time ' + x.join(" ") + '" data-hour="' + n + '" data-minute="' + o + '">' + i.formatDate(s, S.formatTime) + "</div>"
                        }, S.allowTimes && e.isArray(S.allowTimes) && S.allowTimes.length)
                        for (v = 0; v < S.allowTimes.length; v += 1) f(C.strtotime(S.allowTimes[v]).getHours(), j = C.strtotime(S.allowTimes[v]).getMinutes());
                    else
                        for (r = v = 0; v < (S.hours12 ? 12 : 24); v += 1)
                            for (r = 0; r < 60; r += S.step) {
                                var $ = 60 * v + r;
                                $ < A || P <= $ || f((v < 10 ? "0" : "") + v, j = (r < 10 ? "0" : "") + r)
                            }
                    ...
                    W.children().eq(0).html(n), e(O).trigger("generate.xdsoft")
                }), 10), s.stopPropagation()
            })).on("afterOpen.xdsoft", (function() {
                var e, t, i, n;
                S.timepicker && (z.find(".xdsoft_current").length ? e = ".xdsoft_current" : z.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"), e ? (t = P[0].clientHeight, (i = z[0].offsetHeight) - t < (n = z.find(e).index() * S.timeHeightInTimePicker + 1) && (n = i - t), P.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)])) : P.trigger("scroll_element.xdsoft_scroller", [0]))
            })), s = 0, I.on("touchend click.xdsoft", "td", (function(i) {
                ...
                this.touchMoved = !1
            })).on("touchmove", "div", N).on("touchend click.xdsoft", "div", (function(t) {
                if (!this.touchMoved) {
                    t.stopPropagation();
                    var i = e(this),
                        n = C.currentTime;
                ...
                return !S.scrollInput || (!S.datepicker && S.timepicker ? (0 <= (a = z.find(".xdsoft_current").length ? z.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && a + e.deltaY < z.children().length && (a += e.deltaY), z.children().eq(a).length && z.children().eq(a).trigger("mousedown"), !1) : S.datepicker && !S.timepicker ? (A.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), t.val && t.val(C.str()), O.trigger("changedatetime.xdsoft"), !1) : void 0)
                ...
                S.onGenerate && e.isFunction(S.onGenerate) && S.onGenerate.call(O, C.currentTime, O.data("input")), $ && (O.trigger("afterOpen.xdsoft"), $ = !1)
                ...
                var t, i, n, o, r, s, a, l, c, d, u, f, p;
                if (t = (l = O.data("input")).offset(), i = l[0], d = "top", n = t.top + i.offsetHeight - 1, o = t.left, r = "absolute", c = e(S.contentWindow).width(), f = e(S.contentWindow).height(), p = e(S.contentWindow).scrollTop(), S.ownerDocument.documentElement.clientWidth - t.left < A.parent().outerWidth(!0)) {
                    var h = A.parent().outerWidth(!0) - i.offsetWidth;
                    o -= h
                }
                "rtl" === l.parent().css("direction") && (o -= O.outerWidth() - l.outerWidth()), S.fixed ? (n -= p, o -= e(S.contentWindow).scrollLeft(), r = "fixed") : (a = !1, D(i, (function(e) {
                    return null !== e && ("fixed" === S.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(a = !0) : void 0)
                })), a && !S.insideParent ? (r = "fixed", n + O.outerHeight() > f + p ? (d = "bottom", n = f + p - t.top) : n -= p) : n + O[0].offsetHeight > f + p && (n = t.top - O[0].offsetHeight + 1), n < 0 && (n = 0), o + i.offsetWidth > c && (o = c - i.offsetWidth)), s = O[0], D(s, (function(e) {
                ...
                var i = !0;
                M.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), S.onClose && e.isFunction(S.onClose) && (i = S.onClose.call(O, C.currentTime, O.data("input"), t)), !1 === i || S.opened || S.inline || O.hide(), t.stopPropagation()
            })).on("toggle.xdsoft", (function() {
                O.is(":visible") ? O.trigger("close.xdsoft") : O.trigger("open.xdsoft")
            })).data("input", t), F = 0, O.data("xdsoft_datetime", C), O.setOptions(S), C.setCurrentTime(R()), t.data("xdsoft_datetimepicker", O).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function() {
                t.is(":disabled") || t.data("xdsoft_datetimepicker").is(":visible") && S.closeOnInputClick || S.openOnFocus && (clearTimeout(F), F = setTimeout((function() {
                    t.is(":disabled") || ($ = !0, C.setCurrentTime(R(), !0), S.mask && B(S), O.trigger("open.xdsoft"))
                }), 100))
            ...
            if (o) {
                if ("string" === e.type(n)) switch (n) {
                    ...
                    case "validate":
                        ...
                        break;
                    default:
                        o[n] && e.isFunction(o[n]) && (l = o[n](r))
                } else o.setOptions(n);
                return 0
            }
            "string" !== e.type(n) && (!S.lazyInit || S.open || S.inline ? s(e(this)) : (t = e(this)).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", (function e() {
...
function(e) {
    ...
    function l(n) {
        var o, s = n || window.event,
            ...
            h = 0,
            m = 0;
        if ((n = e.event.fix(s)).type = "mousewheel", "detail" in s && (p = -1 * s.detail), "wheelDelta" in s && (p = s.wheelDelta), "wheelDeltaY" in s && (p = s.wheelDeltaY), "wheelDeltaX" in s && (f = -1 * s.wheelDeltaX), "axis" in s && s.axis === s.HORIZONTAL_AXIS && (f = -1 * p, p = 0), u = 0 === p ? f : p, "deltaY" in s && (u = p = -1 * s.deltaY), "deltaX" in s && (f = s.deltaX, 0 === p && (u = -1 * f)), 0 !== p || 0 !== f) {
            if (1 === s.deltaMode) {
            ...
            if (o = Math.max(Math.abs(p), Math.abs(f)), (!i || o < i) && d(s, i = o) && (i /= 40), d(s, o) && (u /= 40, f /= 40, p /= 40), u = Math[1 <= u ? "floor" : "ceil"](u / i), f = Math[1 <= f ? "floor" : "ceil"](f / i), p = Math[1 <= p ? "floor" : "ceil"](p / i), a.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                h = n.clientX - y.left, m = n.clientY - y.top
            }
            return n.deltaX = f, n.deltaY = p, n.deltaFactor = i, n.offsetX = h, n.offsetY = m, n.deltaMode = 0, l.unshift(n, u, f, p), t && clearTimeout(t), t = setTimeout(c, 200), (e.event.dispatch || e.event.handle).apply(this, l)
        }
    }
...
function(e) {
    ...
    v.prototype = {
        ...
        open: function(i) {
            ...
            if (!t.isOpen) {
                ...
                }), 16), t.isOpen = !0, t.updateSize(f), k(d), i
            }
            t.updateItemHTML()
        },
        close: function() {
            ...
            getInline: function(i, n) {
                if (E(), i.src) {
                    ...
                    if (r.length) {
                        ...
                        s && s.tagName && (C || (S = o.hiddenClass, C = _(S), S = "mfp-" + S), D = r.after(C).detach().removeClass(S)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(M, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(M), A = t.st.ajax.cursor, w(a + "." + M, L), w("BeforeChange." + M, L)
            },
            getAjax: function(i) {
                ...
                var n = e.extend({
                    ...
                    success: function(n, o, r) {
                        ...
                        k("ParseAjax", s), t.appendContent(e(s.data), M), i.finished = !0, I(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(h)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, P && clearInterval(P), e.isCheckingImgSize = !1, k("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
                ...
                var i = 0,
                    ...
                    o = function(r) {
                        P && clearInterval(P), P = setInterval((function() {
                            return n.naturalWidth > 0 ? void t._onImageHasSize(e) : (i > 200 && clearInterval(P), void(3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500)))
                        }), r)
                    };
                o(1)
            },
            getImage: function(i, n) {
                ...
                }, i), t.resizeImage(), i.hasSize ? (P && clearInterval(P), i.loadError ? (n.addClass("mfp-loading"), t.updateStatus("error", a.tError.replace("%url%", i.src))) : (n.removeClass("mfp-loading"), t.updateStatus("ready")), n) : (t.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, n.addClass("mfp-loading"), t.findImageSize(i)), n)
            }
        }
    });
    var j;
        ...
        proto: {
            initGallery: function() {
                ...
                return t.direction = !0, !(!i || !i.enabled) && (r += " mfp-gallery", w(d + o, (function() {
                    ...
                    o.counter = s > 1 ? F(i.tCounter, r.index, s) : ""
    ...
    t && Object.deepExtend(n, t), n.tmp.obj = {
        ...
        if (this.radius = (n.particles.size.random ? Math.random() : 1) * n.particles.size.value, n.particles.size.anim.enable && (this.size_status = !1, this.vs = n.particles.size.anim.speed / 100, n.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = i ? i.x : Math.random() * n.canvas.w, this.y = i ? i.y : Math.random() * n.canvas.h, this.x > n.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > n.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), n.particles.move.bounce && n.fn.vendors.checkOverlap(this, i), this.color = {}, "object" == typeof e.value)
            if (e.value instanceof Array) {
                var o = e.value[Math.floor(Math.random() * n.particles.color.value.length)];
        ...
        switch (n.canvas.ctx.fillStyle = o, n.canvas.ctx.beginPath(), e.shape) {
            case "circle":
        ...
        for (var e = 0; e < n.particles.array.length; e++) {
            ...
            if (n.particles.opacity.anim.enable && (1 == t.opacity_status ? (t.opacity >= n.particles.opacity.value && (t.opacity_status = !1), t.opacity += t.vo) : (t.opacity <= n.particles.opacity.anim.opacity_min && (t.opacity_status = !0), t.opacity -= t.vo), t.opacity < 0 && (t.opacity = 0)), n.particles.size.anim.enable && (1 == t.size_status ? (t.radius >= n.particles.size.value && (t.size_status = !1), t.radius += t.vs) : (t.radius <= n.particles.size.anim.size_min && (t.size_status = !0), t.radius -= t.vs), t.radius < 0 && (t.radius = 0)), "bounce" == n.particles.move.out_mode) var o = {
                x_left: t.radius,
                x_right: n.canvas.w,
                y_top: t.radius,
                y_bottom: n.canvas.h
            ...
            switch (t.x - t.radius > n.canvas.w ? (t.x = o.x_left, t.y = Math.random() * n.canvas.h) : t.x + t.radius < 0 && (t.x = o.x_right, t.y = Math.random() * n.canvas.h), t.y - t.radius > n.canvas.h ? (t.y = o.y_top, t.x = Math.random() * n.canvas.w) : t.y + t.radius < 0 && (t.y = o.y_bottom, t.x = Math.random() * n.canvas.w), n.particles.move.out_mode) {
                case "bounce":
        ...
        if (r <= n.particles.line_linked.distance) {
            ...
            if (s > 0) {
                ...
                n.canvas.ctx.strokeStyle = "rgba(" + a.r + "," + a.g + "," + a.b + "," + s + ")", n.canvas.ctx.lineWidth = n.particles.line_linked.width, n.canvas.ctx.beginPath(), n.canvas.ctx.moveTo(e.x, e.y), n.canvas.ctx.lineTo(t.x, t.y), n.canvas.ctx.stroke(), n.canvas.ctx.closePath()
            }
        }
        ...
        n.tmp.pushing = !0;
        for (var i = 0; e > i; i++) n.particles.array.push(new n.fn.particle(n.particles.color, n.particles.opacity.value, {
        ...
        function i(t, i, o, r, s) {
            if (t != i)
                if (n.tmp.bubble_duration_end) {
                    if (null != o) l = t + (t - (r - u * (r - t) / n.interactivity.modes.bubble.duration)), "size" == s && (e.radius_bubble = l), "opacity" == s && (e.opacity_bubble = l)
                } else if (d <= n.interactivity.modes.bubble.distance) {
                if (null != o) var a = o;
                else a = r;
                if (a != t) {
                    var l = r - u * (r - t) / n.interactivity.modes.bubble.duration;
        ...
        if (n.interactivity.events.onhover.enable && isInArray("bubble", n.interactivity.events.onhover.mode)) {
            var o = e.x - n.interactivity.mouse.pos_x,
                r = e.y - n.interactivity.mouse.pos_y,
                s = 1 - (d = Math.sqrt(o * o + r * r)) / n.interactivity.modes.bubble.distance;
            if (d <= n.interactivity.modes.bubble.distance) {
                if (s >= 0 && "mousemove" == n.interactivity.status) {
                    if (n.interactivity.modes.bubble.size != n.particles.size.value)
                        if (n.interactivity.modes.bubble.size > n.particles.size.value) {
                            (l = e.radius + n.interactivity.modes.bubble.size * s) >= 0 && (e.radius_bubble = l)
                        } else {
                        ...
                        if (n.interactivity.modes.bubble.opacity > n.particles.opacity.value) {
                            (c = n.interactivity.modes.bubble.opacity * s) > e.opacity && c <= n.interactivity.modes.bubble.opacity && (e.opacity_bubble = c)
                        } else {
                            var c;
                            (c = e.opacity - (n.particles.opacity.value - n.interactivity.modes.bubble.opacity) * s) < e.opacity && c >= n.interactivity.modes.bubble.opacity && (e.opacity_bubble = c)
                        }
                }
            } else t();
            ...
            if (n.tmp.bubble_clicking) {
                o = e.x - n.interactivity.mouse.click_pos_x, r = e.y - n.interactivity.mouse.click_pos_y;
                var d = Math.sqrt(o * o + r * r),
        ...
        if (n.interactivity.events.onhover.enable && isInArray("repulse", n.interactivity.events.onhover.mode) && "mousemove" == n.interactivity.status) {
            var t = e.x - n.interactivity.mouse.pos_x,
                ...
                s = clamp(1 / (l = n.interactivity.modes.repulse.distance) * (-1 * Math.pow(o / l, 2) + 1) * l * 100, 0, 50),
                a = {
                    x: e.x + r.x * s,
                    y: e.y + r.y * s
                };
            "bounce" == n.particles.move.out_mode ? (a.x - e.radius > 0 && a.x + e.radius < n.canvas.w && (e.x = a.x), a.y - e.radius > 0 && a.y + e.radius < n.canvas.h && (e.y = a.y)) : (e.x = a.x, e.y = a.y)
            ...
            if (n.tmp.repulse_finish || (n.tmp.repulse_count++, n.tmp.repulse_count == n.particles.array.length && (n.tmp.repulse_finish = !0)), n.tmp.repulse_clicking) {
                ...
                l >= u && function() {
                    ...
                    if (e.vx = f * Math.cos(t), e.vy = f * Math.sin(t), "bounce" == n.particles.move.out_mode) {
                        var i = {
                            x: e.x + e.vx,
                            y: e.y + e.vy
                        };
                        (i.x + e.radius > n.canvas.w || i.x - e.radius < 0) && (e.vx = -e.vx), (i.y + e.radius > n.canvas.h || i.y - e.radius < 0) && (e.vy = -e.vy)
                    }
                }()
        ...
        if (n.interactivity.events.onhover.enable && "mousemove" == n.interactivity.status) {
            ...
            if (o <= n.interactivity.modes.grab.distance) {
                ...
                if (r > 0) {
                    ...
                    n.canvas.ctx.strokeStyle = "rgba(" + s.r + "," + s.g + "," + s.b + "," + r + ")", n.canvas.ctx.lineWidth = n.particles.line_linked.width, n.canvas.ctx.beginPath(), n.canvas.ctx.moveTo(e.x, e.y), n.canvas.ctx.lineTo(n.interactivity.mouse.pos_x, n.interactivity.mouse.pos_y), n.canvas.ctx.stroke(), n.canvas.ctx.closePath()
                }
            }
        }
        ...
        for (var i = 0; i < n.particles.array.length; i++) {
            var o = n.particles.array[i],
                r = e.x - o.x,
                s = e.y - o.y;
            Math.sqrt(r * r + s * s) <= e.radius + o.radius && (e.x = t ? t.x : Math.random() * n.canvas.w, e.y = t ? t.y : Math.random() * n.canvas.h, n.fn.vendors.checkOverlap(e))
        }
        ...
        var t = n.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, (function(t, i, n, o) {
            ...
            r = o.createObjectURL(i),
            s = new Image;
        s.addEventListener("load", (function() {
            e.img.obj = s, e.img.loaded = !0, o.revokeObjectURL(r), n.tmp.count_svg++
        })), s.src = r
    }, n.fn.vendors.destroypJS = function() {
        cancelAnimationFrame(n.fn.drawAnimFrame), i.remove(), pJSDom = null
    }, n.fn.vendors.drawShape = function(e, t, i, n, o, r) {
        var s = o * r,
            a = o / r,
            l = 180 * (a - 2) / a,
            c = Math.PI - Math.PI * l / 180;
        e.save(), e.beginPath(), e.translate(t, i), e.moveTo(0, 0);
        for (var d = 0; s > d; d++) e.lineTo(n, 0), e.translate(n, 0), e.rotate(c);
        e.fill(), e.restore()
...
Object.deepExtend = function(e, t) {
        ...
        r.className = n, r.style.width = "100%", r.style.height = "100%", null != document.getElementById(e).appendChild(r) && pJSDom.push(new pJS(e, t))
